<title><?= $configs->site_name ?> - Admin</title>
...
<!-- Muralha de Javascripts -->
<script src="<?= $config->paths->js.'/vendor/jquery.min.js' ?>"></script>
<script src="<?= $config->paths->js.'/vendor/jquery-ui.min.js' ?>"></script>
<script src="<?= $config->paths->js.'/vendor/jquery.ui.touch-punch.min.js' ?>"></script>
<script src="<?= $config->paths->js.'/vendor/jquery.mask.min.js' ?>"></script>
<script src="<?= $config->paths->js.'/vendor/tinymce/tinymce.min.js' ?>"></script>
